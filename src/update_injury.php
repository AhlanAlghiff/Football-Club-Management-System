...
if(isset($_POST['submit'])){
   ...
   if(empty($presence_name) || empty($medical_treatment) || empty($injury_info) || empty($medical_treatment) || empty($recovery_status)){
      ...
      if($upload){
         ...
         $message = 'could not Update the Injury data';
      }
   }
                ...
                <div class="p-6">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="injury_date" value="<?php echo $row['tanggal_cedera']?>" name="injury_date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                        </div>
                        <div class="mb-4">
                            <label for="injury_info" class="block text-sm font-medium text-gray-700">Injury Information</label>
                            <input type="text" id="injury_info" value="<?php echo $row['jenis_cedera']?>" name="injury_info" rows="3" placeholder="Insert Injury Information" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required></input>
                        </div>
                        <div class="mb-4">
                            <label for="medical_treatment" class="block text-sm font-medium text-gray-700">Medical Treatment</label>
                            <input type="text" id="medical_treatment" value="<?php echo $row['tindakan_medis']?>" name="medical_treatment" placeholder="Insert Medical Treatment" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                        </div>
                        <div class="mb-4">
