                ...
                <div class="p-6">
                    ...
                    <form action="" method="post">
                        <div class="mb-4">
                            ...
                            <input type="text" id="presence_name" name="presence_name" placeholder="Insert Player Name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                        </div>
                        <div class="mb-4">
                            <label for="presence_date" class="block text-sm font-medium text-gray-700">Date of Presence</label>
                            <input type="date" id="presence_date" name="presence_date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                        </div>
                        <div class="mb-4">
                            <label for="match_session" class="block text-sm font-medium text-gray-700">Match Session</label>
