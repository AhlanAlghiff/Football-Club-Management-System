...
if(isset($_POST['submit'])){
   ...
   if(empty($schedules_date) || empty($schedules_time) || empty($lokasi) || empty($lawan) || empty($jenis_sesi)){
      ...
      $insert = "INSERT INTO sesi(tanggal, waktu, jenis_sesi, lawan, lokasi) VALUES('$schedules_date', '$schedules_time', '$jenis_sesi', '$lawan', '$lokasi')";
      $upload = mysqli_query($conn,$insert);
      if($upload){
         $message = 'New schedule added successfully!';
      }else{
         $message = 'could not add the schedule';
      }
   }
...
<head>
    ...
    <title>FC Management System | Add Schedule Player</title>
</head>
<body>
